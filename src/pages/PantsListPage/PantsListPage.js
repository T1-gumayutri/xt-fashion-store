...
const PantsListPage = () => {
    ...
    // 2. Tính toán Min/Max Price từ danh sách sản phẩm tải về
    ...
    // Reset bộ lọc giá khi min/max thay đổi
    useEffect(() => {
        setPriceFilter([minPrice, maxPrice]);
    }, [minPrice, maxPrice]);

    // 3. Lấy danh sách màu sắc có sẵn
        ...
        <PageLayout pageTitle="Quần Nam">
            <div className={styles.container}>
                {loading ? (
                    ...
                    <>
                        <h1 className={styles.pageTitle}>Quần Nam</h1>
