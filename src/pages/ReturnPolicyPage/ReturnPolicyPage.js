      ...
      <div className={styles.policyContainer}>
        ...
        <section className={styles.section}>
          ...
          <ul>
            ...
            <li>Trong vòng 30 ngày kể từ ngày mua sản phẩm với các sản phẩm XT Fashion.</li>
        ...
        <section className={styles.section}>
          ...
          <p>Quý khách có thể đổi hàng Online tại hệ thống cửa hàng và đại lý XT Fashion trên toàn quốc . Lưu ý: vui lòng mang theo sản phẩm và phiếu giao hàng.</p>
          <p>Nếu tại khu vực bạn không có cửa hàng XT Fashion hoặc sản phẩm bạn muốn đổi thì vui lòng làm theo các bước sau:</p>
          <ol className={styles.steps}>
            ...
            <li><strong>Bước 2:</strong> Vui lòng gửi hàng đổi về địa chỉ : Kho Online XT Fashion - 1165 Giải Phóng, Thịnh Liệt, Q. Hoàng Mai, Hà Nội.</li>
            <li><strong>Bước 3:</strong> XT Fashion gửi đổi sản phẩm mới khi nhận được hàng. Trong trường hợp hết hàng, XT Fashion sẽ liên hệ xác nhận.</li>
          </ol>
        </section>
      </div>
    </PageLayout>
